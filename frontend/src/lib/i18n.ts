...
export const messages = {
  en: {
    ...
    heroTitleLines: ["Will AI replace your occupation?"],
    heroText:
      "AIRS stands for AI Recruitment Stability Score. The higher the score, the lower the current AI impact. It does not try to guess whether a job will disappear someday. It asks a narrower and more useful question: once AI enters a workflow, are employers already reducing openings, simplifying roles, or reorganizing how that occupation is staffed?",
    summaryCards: [
  ...
  zh: {
    ...
    heroTitleLines: ["AI会取代你的职业吗？"],
    heroText:
      "AIRS是AI Recruitment Stability Score的缩写，即“AI招聘稳定指数”。分数越高，受AI影响越小。它不是在预测某个职业未来会不会消失，而是用招聘变化回答一个更直接的问题：当 AI 进入工作流程后，企业是否已经开始减少招聘、简化岗位，或重组这个职业的用人方式。",
    summaryCards: [
      { code: "01", label: "平均分" },
      { code: "02", label: "风险集中" },
      { code: "03", label: "改写占比" },
    ...
    liveFieldTitle: "把全部 BLS SOC 职业放进一张可缩放的职业地图里。",
    date: "日期",
    region: "地区",
    group: "职业大类",
    label: "影响类型",
    ...
    zoomOut: "缩小",
    resetView: "回到全局视图",
    viewModesKicker: "查看方式",
    mapModeMarket: "整体市场",
    mapModeGroup: "职业大类",
    mapModeLabel: "风险聚类",
    axisX: "横轴是 AIRS 分数：越靠左，说明 AI 对招聘压缩越明显；越靠右，说明当前影响越小。",
    ...
    tasksIntro: "这里的“影响程度”越高，说明这项具体工作内容越容易先被 AI 辅助、重写或部分压缩。",
