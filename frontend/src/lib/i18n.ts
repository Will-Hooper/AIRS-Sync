...
export const messages = {
  en: {
    ...
    axisXTitle: "X axis",
    axisYTitle: "Y axis",
    axisX: "AIRS score. Further right means this role is currently less exposed to AI pressure.",
    axisY: "Hiring impact. Higher up means the AI shock is showing up in hiring sooner.",
    ...
    shareQrDescription: "Scan or post this code so others can open airsindex.com.",
  ...
  zh: {
    ...
    axisXTitle: "横轴",
    axisYTitle: "纵轴",
    axisX: "AIRS 分数。越靠右，说明这份工作当前越不容易被 AI 冲击。",
    axisY: "招聘影响。越靠上，说明 AI 的冲击越早反映到招聘上。",
    openDetail: "查看详情",
    detailKicker: "职业详情",
    ...
    shareQrDescription: "扫码或发布这张图后，都可统一打开 airsindex.com。",
    footerCopyright: "© 2026 airsindex.com, all rights reserved DSDPM",
    footerRecordNumber: "京ICP备2026017743号",
    footerContact: "联系我",
