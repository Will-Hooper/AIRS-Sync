...
function ThemeGlyph() {
  return (
    <svg aria-hidden="true" viewBox="0 0 32 32" className="h-6 w-6" fill="none">
      <path d="M16 7.2a8.8 8.8 0 1 0 0 17.6V7.2Z" fill="currentColor" />
      <path
...
export function H5ThemeSwitch({ language, theme, onChange }: H5ThemeSwitchProps) {
  ...
  return (
    <CircularToggleButton title={title} ariaPressed={theme === "dark"} onClick={() => onChange(nextTheme)} size="mobile">
